...
type Config struct {
	...
	DayCategoryCount    map[int32]string `protobuf:"bytes,8,rep,name=day_category_count,json=dayCategoryCount,proto3" json:"day_category_count,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
